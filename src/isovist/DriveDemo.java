...
public class DriveDemo
    ...
    TrajectoryPlanner trajectoryPlannerWithBackdriving = new LongrangePlanner(
      LongrangeProfile.createBestPracticeProfile()
        .setPlanningFlagsWithTargetAngle(
          ...
          Maneuver.FLAGS_ARCS_UPTO_360_DEGREES |
        ...
        .setChangeDrivingDirectionData(
          50, // changeDrivingDirectionCosts
          Robot.headingDistance * 3.0d
        ) // changeDrivingDirectionMinObstacleDist
        .setAlgoFlags(
      ...
      new LongrangePlanner(
        LongrangeProfile.createBestPracticeProfile()
          ...
          .setSnakeProfile(
            ...
            new double[] { 1.5d, 1.0d }
          ) // Wird eigentlich nicht gebraucht, da oben ausgeschlossen
          .setDubinsArcsProfile(
  ...
  public String getDescription() {
    return (
      "Robot controller " +
      getClass().getName() +
      " navigation/trajectoryplanning/driving demo (no configuration accepted)"
    );
  }
  ...
  public void pause() throws Exception {
    ...
    if (driver != null) driver.halt(Driver.HALT_REASON_CONTROLLER_PAUSE);
  }
  ...
  public void stop() throws Exception {
    ...
    if (driver != null) driver.halt(Driver.HALT_REASON_CONTROLLER_STOP);
    ...
    if (driver != null && !driver.isHalted() && navTraj.hasRouted()) {
      ...
      if (!navTraj.addObstacles(newObstacles.getAll2D())) { // Hinzufügen der neuen Punkte, bei false ging das nicht, da z.B. der grid zu klein war
        driver.halt(
          ...
          "Cannot add new obstacles to navigation world model"
        ); // Bei Fehlschlag neu-Routing initiieren
        return;
      }
